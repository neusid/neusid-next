...
export default function ProjectDetailsContent({ project, id }) {
    ...
    const images = Array.isArray(project.images)
        ? project.images
        : [project.images || "project4.jpeg"]
    const description =
        project.data?.[0]?.description || "No description available."
